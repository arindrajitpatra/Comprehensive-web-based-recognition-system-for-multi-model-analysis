    ...
    while True:
        ...
        if len(DP) != 0:
            for i in range(len(detect_params[0])):
                ...
                object_img = frame[int(bb[1]):int(bb[3]), int(bb[0]):int(bb[2])]
        ...
        for y in result:
            if y[2] > conf_threshold:
                ...
                cv2.putText(frame, f'Color: {color_label}', (top_left_corner[0], top_left_corner[1] + 30), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0), 2)
...
if __name__ == "__main__":
    urlcol()  # This is the combined code